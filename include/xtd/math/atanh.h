...
namespace xtd {
   ...
   */
  XTD_DEVICE_FUNCTION inline constexpr float16_t atanh(float16_t arg) {
  ...
  /* Computes the inverse hyperbolic tanget of arg, in half precision.
   */
  XTD_DEVICE_FUNCTION inline constexpr float16_t atanhf(xtd::floating_point auto arg) {
    return xtd::atanh(static_cast<float16_t>(arg));
  }
