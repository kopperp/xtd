...
inline float16 mpfr_acosf(xtd::arithmetic auto arg) {
  float result;
...
inline double mpfr_acos(xtd::arithmetic auto arg) {
  double result;
  mpfr::acos(static_cast<mpfr_double>(static_cast<double>(arg))).conv(result);
  return result;
}
